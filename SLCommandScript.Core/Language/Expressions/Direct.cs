...
public abstract class Direct
{
    ...
    public class If : Direct
    {
        ...
        public override T Accept<T>(IVisitor<T> visitor) => visitor is null ? default : visitor.VisitIfDirect(this);
    }
    ...
    public class Foreach : Direct
    {
        ...
        /// <exception cref="NullReferenceException">When provided visitor is <see langword="null" />.</exception>
        /// <returns>Result of accepted visit.</returns>
        public override T Accept<T>(IVisitor<T> visitor) => visitor is null ? default : visitor.VisitForeachDirect(this);
    }
