...
public class Lexer
{
    ...
    /// <summary>
    /// Initializes tokenization process.
    /// </summary>
    private void Init()
    {
    ...
    private TokenType ProcessArgument(int argNum, int startedAt, bool isVarText)
    {
        ...
        var lexer = new Lexer(_arguments.Array[_arguments.Offset + argNum - 1], Line);
    ...
    private void ValidateArgs(int argNum)
    {
        ...
        {
            ErrorMessage = $"[Lexer] Invalid argument $({argNum}), provided arguments array has incorrect offset";
            return;
        }
