...
public static class DoorIterablesProvider
{
    ...
    public static IIterable AllDoors() => new IterableList<FacilityDoor>(() => FacilityDoor.List, LoadVariables);

    /// <summary>
    /// Retrieves iterable object for all breakable doors.
    /// </summary>
    /// <returns>Iterable object for all breakable doors.</returns>
    public static IIterable AllBreakableDoors() => new IterableList<FacilityDoor>(() => FacilityBreakableDoor.List, LoadVariables);

    /// <summary>
    /// Retrieves iterable object for all gates.
    /// </summary>
    /// <returns>Iterable object for all gates.</returns>
    public static IIterable AllGates() => new IterableList<FacilityDoor>(() => FacilityGate.List, LoadVariables);

    /// <summary>
    /// Retrieves iterable object for all locked doors.
    /// </summary>
    /// <returns>Iterable object for all locked doors.</returns>
    public static IIterable AllLockedDoors() => new IterableList<FacilityDoor>(() => FacilityDoor.List.Where(d => d.IsLocked), LoadVariables);

    /// <summary>
    /// Retrieves iterable object for all unlocked doors.
    /// </summary>
    /// <returns>Iterable object for all unlocked doors.</returns>
    public static IIterable AllUnlockedDoors() => new IterableList<FacilityDoor>(() => FacilityDoor.List.Where(d => !d.IsLocked), LoadVariables);

    /// <summary>
    /// Retrieves iterable object for all opened doors.
    /// </summary>
    /// <returns>Iterable object for all opened doors.</returns>
    public static IIterable AllOpenedDoors() => new IterableList<FacilityDoor>(() => FacilityDoor.List.Where(d => d.IsOpened), LoadVariables);

    /// <summary>
    /// Retrieves iterable object for all closed doors.
    /// </summary>
    /// <returns>Iterable object for all closed doors.</returns>
    public static IIterable AllClosedDoors() => new IterableList<FacilityDoor>(() => FacilityDoor.List.Where(d => !d.IsOpened), LoadVariables);
