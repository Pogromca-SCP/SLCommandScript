...
public class FileScriptsLoader : IScriptsLoader
{
    ...
    private void RegisterScript(string scriptFile, CommandType handlerType)
    {
    ...
    private void UnregisterScript(string scriptFile, CommandType handlerType)
    {
        var dir = _registeredDirectories[handlerType];
    ...
    private void RefreshScript(string oldFileName, string newFileName, CommandType handlerType)
    {
